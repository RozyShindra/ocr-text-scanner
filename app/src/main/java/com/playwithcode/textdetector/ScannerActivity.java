...
public class ScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img =  findViewById(R.id.image);  //(ImageView)
        textview = findViewById(R.id.text);  //(TextView)
        snapBtn = findViewById(R.id.snapbtn);  //(Button)
        detectBtn = findViewById(R.id.detectbtn);  // (Button)
